...
//
//        try {
//            glavniGradUpit = conn.prepareStatement("SELECT grad.id, grad.naziv, grad.broj_stanovnika, grad.drzava, grad.tip FROM grad, drzava WHERE grad.drzava=drzava.id AND drzava.naziv=?");
//        } catch (SQLException e) {
//            regenerisiBazu();
//            try {
//                glavniGradUpit = conn.prepareStatement("SELECT grad.id, grad.naziv, grad.broj_stanovnika, grad.drzava, grad.tip FROM grad, drzava WHERE grad.drzava=drzava.id AND drzava.naziv=?");
...
//
//            promijeniGradUpit = conn.prepareStatement("UPDATE grad SET naziv=?, broj_stanovnika=?, drzava=?, tip=? WHERE id=?");
//        } catch (SQLException e) {
//            e.printStackTrace();
//        }
//
...
//        int tip = rs.getInt(5);
//        if (tip == 1)
//            grad = new RazvijeniGrad(rs.getInt(1), rs.getString(2), rs.getInt(3), null);
//        else if (tip == 2)
//            grad = new SrednjeRazvijeniGrad(rs.getInt(1), rs.getString(2), rs.getInt(3), null);
//        else
//            grad = new NerazvijeniGrad(rs.getInt(1), rs.getString(2), rs.getInt(3), null);
...
//                dodajGradUpit.setInt(5, 1);
//            else if (grad instanceof SrednjeRazvijeniGrad)
//                dodajGradUpit.setInt(5, 2);
//            else
//                dodajGradUpit.setInt(5, 3);
...
//
//            if (grad instanceof RazvijeniGrad)
//                promijeniGradUpit.setInt(4, 1);
//            else if (grad instanceof SrednjeRazvijeniGrad)
//                promijeniGradUpit.setInt(4, 2);
//            else
//                promijeniGradUpit.setInt(4, 3);
//
...
//    }
//
//    // Ova metoda služi da se ne moraju mijenjati testovi kada klasa Grad postane apstraktna
//    public static Grad dajGradDaProdjuTestovi() {
//        return new RazvijeniGrad();
//    }
//}
